...
| 36        | <pre> sed -i 's#`${admin}#$admin#g' /etc/httpd/conf.d/$address.conf && sed -i 's#`${www}#$WWWHome#g' /etc/httpd/conf.d/$address.conf && sed -i 's#`${name}#$address#g' /etc/httpd/conf.d/$address.conf </pre>|

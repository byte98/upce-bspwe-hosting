...
| 33        | <pre>sed -i 's#`${admin}#<b><i>$admin</b></i>#g' /etc/httpd/conf/httpd.conf</pre>                                                                                                                       |
| 34        | <pre>sed -i '/^[^#]/ s/^/# /' /etc/httpd/conf.d/welcome.conf </pre>                                                                                                                                     |
| 35        | <pre>wget -O /etc/httpd/conf.d/<b><i>$address</b></i>.conf </pre>                                                                                                                                       |
| 36        | <pre>sed -i 's#`${admin}#<b><i>$admin</b></i>#g' /etc/httpd/conf.d/<b><i>$address</b></i>.conf && sed -i 's#`${www}#<b><i>$WWWHome</b></i>#g' /etc/httpd/conf.d/<b><i>$address</b></i>.conf && sed -i 's#`${name}#<b><i>$address</b></i>#g' /etc/httpd/conf.d/<b><i>$address</b></i>.conf</pre>|
| 37        | <pre>systemctl restart httpd</pre>                                                                                                                                                                      |
